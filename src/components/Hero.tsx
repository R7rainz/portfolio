    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="flex flex-col justify-center items-center min-h-[calc(100vh-80px)] px-6">
        <div className="max-w-5xl w-full">
          ...
          >
            {/* Animated profile picture above name (responsive + glow + status) */}
            <motion.div
              className="flex justify-center mb-8"
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  transition={{ delay: 0.9, duration: 0.25, type: "spring" }}
                >
                  <motion.div
            ...
            {/* the original name, underline, and subtitle remain below */}
            <motion.h1
                ...
                <div className="space-y-4">
                  ...
                  <div className="font-jetbrains text-sm space-y-2">
                    {[
                      ...
                      {
                        label: "Kernel",
                        value: "6.16.8-arch3-1",
                        color: "text-green-400",
                      },
                      {
                        label: "WM",
                        value: "Hyprland 0.51.1",
                ...
                >
                  {[
                    ...
                    <motion.div
                      ...
                      initial={{ opacity: 0, y: 20 }}
                      animate={{ opacity: 1, y: 0 }}
                      transition={{ delay: 3.25 + index * 0.08, duration: 0.3 }}
